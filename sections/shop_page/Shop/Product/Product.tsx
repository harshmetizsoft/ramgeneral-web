                        ...
                        <div className="col-xl-9 col-lg-8">
                            ...
                            <div className="pagination justify-content-center">
                                <ul>
                                    ...
                                    <li><Link href="/blog"><i className="ri-arrow-right-line"></i></Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-4">
                            <aside className="sidebar-area">
                                ...
                                <div className="widget widget_categories">
                                    ...
                                    <ul>
                                        <li>
                                            <Link href="/blog">Construction <span>12</span></Link>
                                        </li>
                                        <li>
                                            <Link href="/blog">Architecture <span>7</span></Link>
                                        </li>
                                        <li>
                                            <Link href="/blog">Business <span>5</span></Link>
                                        </li>
                                        <li>
                                            <Link href="/blog">Engineering <span>3</span></Link>
                                        </li>
                                        <li>
                                            <Link href="/blog">Building <span>2</span></Link>
                                        </li>
                                    </ul>
                                </div>
